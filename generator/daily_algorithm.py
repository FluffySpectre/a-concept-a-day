...
prompt = (
    ...
    "- A description of the algorithm in the form of <li>1. Step 1</li><li>2. Step 2</li><li>3. Step 3</li> etc. Format it as HTML list.\n"
    ...
    "\"step_description\": \"A description of the algorithm in the form of <li>1. Step 1</li><li>2. Step 2</li><li>3. Step 3</li> etc. Format it as HTML list.\","
